...
const AdminWebhooks = lazy(() => import("@/components/admin/system/AdminWebhooks"));
const AdminCoupons = lazy(() => import("@/components/admin/finance/AdminCoupons"));
const AdminReferral = lazy(() => import("@/components/admin/finance/AdminReferral"));
const AdminVipTiers = lazy(() => import("@/components/admin/finance/AdminVipTiers"));
const AdminLeaderboard = lazy(() => import("@/components/admin/finance/AdminLeaderboard"));
const AdminDataReset = lazy(() => import("@/components/admin/system/AdminDataReset"));
const AdminFinanceCleanup = lazy(() => import("@/components/admin/finance/AdminFinanceCleanup"));
const AdminBackup = lazy(() => import("@/components/admin/system/AdminBackup"));
const AdminGeneralTab = lazy(() => import("@/components/admin/main/AdminGeneralTab"));
const AdminUsersTab = lazy(() => import("@/components/admin/users/AdminUsersTab"));
const AdminBrandingTab = lazy(() => import("@/components/admin/main/AdminBrandingTab"));
const AdminThemeTab = lazy(() => import("@/components/admin/main/AdminThemeTab"));
const AdminCategoriesTab = lazy(() => import("@/components/admin/catalog/AdminCategoriesTab"));
const AdminProductsTab = lazy(() => import("@/components/admin/catalog/AdminProductsTab"));
const AdminTopUpTab = lazy(() => import("@/components/admin/finance/AdminTopUpTab"));
const AdminLayoutTab = lazy(() => import("@/components/admin/main/AdminLayoutTab"));
const AdminMusicTab = lazy(() => import("@/components/admin/main/AdminMusicTab"));
const AdminLegalTab = lazy(() => import("@/components/admin/main/AdminLegalTab"));
const AdminKeysTab = lazy(() => import("@/components/admin/catalog/AdminKeysTab"));
const AdminQuickNavTab = lazy(() => import("@/components/admin/catalog/AdminQuickNavTab"));
const AdminServicesTab = lazy(() => import("@/components/admin/catalog/AdminServicesTab"));
const AdminWheelsTab = lazy(() => import("@/components/admin/catalog/AdminWheelsTab"));
const AdminWheelClaimsTab = lazy(() => import("@/components/admin/catalog/AdminWheelClaimsTab"));
const AdminDiscountTab = lazy(() => import("@/components/admin/finance/AdminDiscountTab"));
const AdminTransactionsTab = lazy(() => import("@/components/admin/finance/AdminTransactionsTab"));
const AdminLinkPagesTab = lazy(() => import("@/components/admin/catalog/AdminLinkPagesTab"));
const AdminAuditLogTab = lazy(() => import("@/components/admin/system/AdminAuditLogTab"));
const AdminPermissionsTab = lazy(() => import("@/components/admin/users/AdminPermissionsTab"));
const AdminRuzienBypassTab = lazy(() => import("@/components/admin/system/AdminRuzienBypassTab"));
const AdminRoleAccessTab = lazy(() => import("@/components/admin/users/AdminRoleAccessTab"));
const AdminEffectsTab = lazy(() => import("@/components/admin/main/AdminEffectsTab"));
