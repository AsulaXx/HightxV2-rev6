              ...
              return (
                ...
                >
                  ...
                  <div className="relative aspect-[4/5] bg-muted/30 overflow-hidden">
                    {product.imageUrl ? (
                      <img src={product.thumbnailUrl || product.imageUrl} alt={product.name} className="w-full h-full object-cover transition-transform group-hover:scale-105" loading="lazy" />
                    ) : (
